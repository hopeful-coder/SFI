...
Ventura County Project to Support Reentry (VCPA) launched on October 23, 2017 by Interface Children & Family Services (ICFS or ”Interface”) and Social Finance (SFI). ICFS is a trusted nonprofit social services agency, serving Ventura County’s
...
Success Initiative. Pay for Success (PFS) is an approach to outcomes-based funding. PFS gives payment for service to
achievements exhibiting measurable progress and outcomes. It has been used to fund efforts like early
education, job training, criminal justice reform, and health interventions where desired outcomes such as
long-term employment, school readiness, and better health occur over time. This specific award is aimed at advancing the PFS field in California by providing funding for
...
VCPA will consist of Interface randomizing probationers into a PFS group and probation as usual
...
building, and employment support and placement. Each of the probationers are followed for at most
6 quarters. Any subsequent arrests post-release are recorded. This will lead to a measured outcome of
...
Demographics were anlayzed for difference between groups. We looked for specific differences between the PFS and control group. 
